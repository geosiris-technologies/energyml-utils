...
public class EPCPackage_Resqml_Dev6 extends EPCPackage {
	private final static String staticPkgPath = "energyml.resqml_dev6x_";
	...
	public EPCPackage_Resqml_Dev6(String xsdMappingFilePath) {
		super("resqml (dev6)", staticPkgPath, xsdMappingFilePath);
		logger.info("EPCPackage_Resqml_dev6 initialized "  + pkgClasses.keySet());
	}
