...
public class EPCPackage_Resqml_Dev5 extends EPCPackage {
	private final static String staticPkgPath = "energyml.resqml_dev5x_";
	...
	public EPCPackage_Resqml_Dev5(String xsdMappingFilePath) {
		super("resqml (dev5)", staticPkgPath, xsdMappingFilePath);
		logger.info("EPCPackage_Resqml_dev5 initialized "  + pkgClasses.keySet());
	}
