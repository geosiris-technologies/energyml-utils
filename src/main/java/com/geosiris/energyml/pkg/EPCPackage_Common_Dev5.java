...
public class EPCPackage_Common_Dev5 extends EPCPackage {
	private final static String staticPkgPath = "energyml.common_dev5x_";
	
	public static final Map<String, List<Class<?>>> pkgClasses = searchAllClassesForVersions(staticPkgPath);

	public EPCPackage_Common_Dev5(String xsdMappingFilePath) {
		super("common (dev5)", staticPkgPath, xsdMappingFilePath);
		logger.info("EPCPackage_Common_dev5 initialized "  + pkgClasses.keySet());
	}
